        ...
        <div className=" dark:bg-dark-green bg-green ">
            <div className=" w-[70%] mx-auto pb-10">
                ...
                {projects.map(project=>(
                    <div key={project.id} className="w-full mx-auto bg-white dark:bg-brown rounded-xl shadow-md overflow-hidden mt-5">
                            ...
                            <ul className="flex">
                                {
                                   project.keywords.map((keyword,index)=>(
                                     <li key={index} className="bg-purple dark:bg-light-purple text-white text-center w-20 h-8 leading-8 rounded-full mr-3">{keyword}</li>
                                )) 
                                }
                            </ul>
